...
public class asu extends atl {
    ...
    public atm a(int var1, int var2) {
        if (!this.d()) {
            return null;
        } else {
            auf var3 = new auf(this.a.y, this.a.c, this.a.d);
            int var4 = var3.e();
            ...
            if (var5 >= 0 && var6 >= 0) {
                ...
                if (var5 <= 320 && var6 < this.a.p.b * var7 + var7) {
                    ...
                    System.out.println("lineIndex : "+var8+" -> "+getImprovedLines().get(var8).a());
                    return new atm(this.a.p, (arm) this.getImprovedLines().get(var8), var5, var6 - (var8 - this.d) * this.a.p.b + var8);
                } else {
                    return null;
                }
            } else {
    ...
    public void a(String var1, Object... var2) {
        this.a(bn.a().a(var1, var2));
    }

    public boolean d() {
        return this.a.r instanceof asw;
    }
    ...
    public void addImpChatLine(arm line) {
        this.c.add(line);
        this.b.add(line.a());
    }

    private List<arm> getImprovedLines() {
